...
Image release: push a `docker-web-tuktuk-pyth-service-<version>` tag by hand (see [repo README](../../README.md#deploying-docker-services)). The service deploy (the k8s bump) stays manual.
