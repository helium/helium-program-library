...
```
 npx ts-node --project tsconfig.cjs.json src/create-price-oracle.ts -u https://api.devnet.solana.com  --multisig BBhoCZSUJH8iiXHT5aP6GVbhnX2iY2vWR1BAsuYm7ZUm --priceOracleKeypair keypairs/hnt-price-oracle.json --oracles oracles.json
```
