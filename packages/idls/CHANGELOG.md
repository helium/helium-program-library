...
- [#1248](https://github.com/helium/helium-program-library/pull/1248) [`a136ccd`](https://github.com/helium/helium-program-library/commit/a136ccd393a5e761883ad02ee8395902f89ac397) Thanks [@madninja](https://github.com/madninja)! - `mini-fanout` stores and queues a pre task only when it is one of two shapes: a remote
...
- [#1215](https://github.com/helium/helium-program-library/pull/1215) [`efb402a`](https://github.com/helium/helium-program-library/commit/efb402a0c58ab014767110777627a0348cd68a0e) Thanks [@bryzettler](https://github.com/bryzettler)! - Republish IDL types with the HIP 149 changes from #1197: `queue_end_epoch` now requires the `hnt_price_oracle` account and `calculate_utility_score_v0` accepts an optional `hnt_price_oracle`
