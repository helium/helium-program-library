...
- [#1201](https://github.com/helium/helium-program-library/pull/1201) [`c6e759e`](https://github.com/helium/helium-program-library/commit/c6e759e421db942e69d6ad357c65d735e0ca2bae) Thanks [@bryzettler](https://github.com/bryzettler)! - Drop the hardcoded 500k compute-unit limit in `useAutomateHotspotClaims`; limits now come from spl-utils' measured compute-unit table.
