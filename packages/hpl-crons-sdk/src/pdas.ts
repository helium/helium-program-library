...
export function entityCronAuthorityKey(
  wallet: PublicKey,
...
export function queueAuthorityKey(programId = PROGRAM_ID): [PublicKey, number] {
  return PublicKey.findProgramAddressSync(
...
export function epochTrackerKey(
  dao: PublicKey,
  programId = PROGRAM_ID
): [PublicKey, number] {
  return PublicKey.findProgramAddressSync(
...
export function taskReturnAccountKey(
  programId = PROGRAM_ID
): [PublicKey, number] {
  return PublicKey.findProgramAddressSync(
