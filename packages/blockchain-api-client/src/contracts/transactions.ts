...
export const transactionsContract = oc.tag("Transactions").router({
  ...
  getByPayerAndTag: oc
    .route({
      method: "GET",
      path: "/transactions/payer/{payer}/tag/{tag}",
      summary: "Get transactions by payer and tag",
    })
  ...
  estimate: oc
    .route({
      ...
      summary: "Estimate transaction costs",
    })
  ...
  history: oc
    .route({
      method: "GET",
      path: "/transactions/history/{payer}",
