...
export const welcomePacksContract = oc.tag("Welcome Packs").router({
  /** Public: List welcome packs for a wallet */
  list: oc
    .route({
      method: "GET",
      path: "/welcome-packs/{walletAddress}",
      summary: "List welcome packs for a wallet",
    })
  ...
  get: oc
    .route({
      method: "GET",
      path: "/welcome-packs/{walletAddress}/{packId}",
      summary: "Get a specific welcome pack",
    })
  ...
  getByAddress: oc
    .route({
      method: "GET",
      path: "/welcome-packs/address/{packAddress}",
      summary: "Get welcome pack by pack address",
    })
  ...
  claim: oc
    .route({
      method: "POST",
      path: "/welcome-packs/claim",
      summary: "Claim a welcome pack",
    })
  ...
  invite: oc
    .route({
      method: "POST",
      path: "/welcome-packs/invite",
      summary: "Send an invite for a welcome pack",
    })
