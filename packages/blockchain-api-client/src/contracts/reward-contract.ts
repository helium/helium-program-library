  ...
  .router({
    find: oc
      .route({
        ...
        description:
          "Retrieves the reward contract (pending or active) associated with a specific hotspot entity.",
      })
      .input(
        z.object({
    ...
    estimateCreationCost: oc
      .route({
        ...
        description:
          "Estimates the cost to create a reward contract for a specific hotspot entity.",
      })
      .input(
        CreateRewardContractTransactionInputSchema.extend({
          entityPubKey: HeliumPublicKeySchema.describe(
            "The public key of the hotspot entity"
          ),
        })
      )
    ...
    create: oc
      ...
      .input(
        CreateRewardContractTransactionInputSchema.extend({
          ...
          signerWalletAddress: WalletAddressSchema.describe(
            "The wallet address of the caller"
          ),
        })
      )
      .errors({
    ...
    delete: oc
      .route({
        ...
        description:
          "Assembles an unsigned transaction to delete a reward contract (pending or active) for a specific hotspot entity.",
      })
      .input(
        z.object({
          entityPubKey: HeliumPublicKeySchema.describe(
    ...
    invite: oc
      .route({
        ...
        description:
          "Assembles details required to create a shareable invite to claim a pending reward contract.",
      })
      .input(
        z.object({
          entityPubKey: HeliumPublicKeySchema.describe(
    ...
    claim: oc
      .route({
        ...
        description:
          "Assembles an unsigned transaction which can be used to claim an invite.",
      })
      .input(
