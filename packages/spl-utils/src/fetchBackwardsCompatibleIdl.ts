...
const IDLS_BY_PROGRAM: Record<string, any> = {
  ...
  pvr1pJdeAcW6tzFyPRSmkL5Xwysi1Tq79f7KF2XB4zM: {
    version: "0.0.1",
        ...
        accounts: [
          {
            ...
            isMut: false,
            isSigner: false,
            relations: ["rewards_mint", "registrar"],
          },
          {
            name: "position",
            isMut: false,
      ...
      },
      {
        ...
        accounts: [
          ...
          },
          {
            ...
            isMut: true,
            isSigner: false,
            relations: ["rewards_authority", "rewards_mint", "registrar"],
          },
          {
            name: "registrar",
            isMut: false,
      ...
      },
      {
        ...
        accounts: [
          ...
          },
          {
            ...
            relations: ["vetoken_tracker", "position"],
          },
          {
            name: "vsrEpochInfo",
            isMut: true,
      ...
      },
      {
        ...
        type: {
          ...
          fields: [
            ...
            {
              name: "proposalNamespace",
              docs: ["The org to track proposals from"],
              type: "publicKey",
            },
            {
              name: "rewardsMint",
        ...
        args: [
          {
            name: "args",
            type: {
              defined: "UpdateRegistrarArgsV0",
            },
          },
        ],
      },
      {
        name: "freezePositionV0",
        accounts: [
          {
            name: "authority",
            isMut: true,
      ...
      },
      {
        ...
        type: {
          ...
          fields: [
            ...
            {
              name: "positionFreezeAuthorities",
              type: {
                vec: "publicKey",
              },
            },
  ...
  hdaoVTCqhfHHo75XdAMxBKdUqvq1i5bF23sisBqVgGR: {
    ...
    instructions: [
      ...
      {
        name: "issueVotingRewardsV0",
        accounts: [
          {
            name: "subDao",
            isMut: false,
            isSigner: false,
            relations: ["registrar", "vetoken_tracker"],
          },
          {
            name: "rentPayer",
            isMut: true,
            ...
            pda: {
              seeds: [
                ...
                },
                {
                  kind: "arg",
                  type: {
                    defined: "IssueVotingRewardsArgsV0",
                  },
                  path: "args.epoch",
                },
              ],
          ...
          {
            name: "rewardsMintCircuitBreaker",
            isMut: true,
            isSigner: false,
            pda: {
              seeds: [
