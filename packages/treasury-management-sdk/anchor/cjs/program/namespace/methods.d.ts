...
declare type PartialAccounts<A extends IdlAccountItem = IdlAccountItem> = Partial<{
    [N in A["name"]]: PartialAccount<A & {
        name: N;
    }>;
}>;
declare type PartialAccount<A extends IdlAccountItem> = A extends IdlAccounts ? Partial<Accounts<A["accounts"][number]>> : Address;
export declare class MethodsBuilder<IDL extends Idl, I extends AllInstructions<IDL>> {
    ...
    accounts(accounts: PartialAccounts): MethodsBuilder<IDL, I>;
