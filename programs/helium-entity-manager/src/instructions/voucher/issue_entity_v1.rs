...
use crate::{
  ...
  IssueEntityArgsV0, ECC_VERIFIER,
};

#[derive(Accounts)]
#[instruction(args: IssueEntityArgsV0)]
pub struct IssueEntityV1<'info> {
  #[account(mut)]
...
pub fn handler(ctx: Context<IssueEntityV1>, args: IssueEntityArgsV0) -> Result<()> {
