...
Deploy: push a `docker-web-ecc-verifier-<version>` tag by hand. Push the tag by hand for a hotfix, a minor, or a major (see [repo README](../../README.md#deploying-docker-services)). The k8s bump stays manual.
